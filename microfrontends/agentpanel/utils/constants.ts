...
export const API_BASE_URL = import.meta.env.VITE_AGENT_API_URL || 'http://10.10.12.117:3030/api'
export const SOCKET_URL = import.meta.env.VITE_AGENT_SOCKET_URL || 'http://10.10.12.117:3030'
